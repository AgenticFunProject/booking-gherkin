...
**YOU ARE IN: `booking_gherkin/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/booking_gherkin/` (rig root) or other directories
...
**Your mail address:** `booking_gherkin/polecats/furiosa`
**Your rig:** booking_gherkin
**Your Witness:** `booking_gherkin/witness`
...
| Ask Witness for help | `gt mail send booking_gherkin/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`booking_gherkin/witness`) when:
...
```bash
gt mail send booking_gherkin/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
